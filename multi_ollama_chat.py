...
try:
    ...
    print("Failed to import 'ollama' package. Install it with 'pip install ollama'", file=sys.stderr)
    raise
...
def run_conversation(topic, turns=5, delay=1.0, log_path=None, humanize=False, greeting=None, persona_a=None, persona_b=None, max_chars=None, short_turn=False, model_a=None, model_b=None):
        ...
        for i in range(turns):
            ...
            for _ in range(2):
                ...
                if sim < 0.5:  # much stricter threshold
                    messages_b.append({'role': 'user', 'content': f'IMPORTANT: Stay strictly on topic: "{topic}". Give a short, focused answer only about this topic.'})
            ...
            for _ in range(2):
                ...
                if sim < 0.5:
                    messages_a.append({'role': 'user', 'content': f'IMPORTANT: Stay strictly on topic: "{topic}". Give a short, focused answer only about this topic.'})
...
def parse_args():
    ...
    p.add_argument('--humanize', action='store_true', help='Make agents reply in a short, human-like conversational style')
    p.add_argument('--greeting', type=str, default=None, help='Optional greeting/initial prompt when using --humanize')
    p.add_argument('--persona-a', type=str, default=None, help='Optional persona string for Agent A')
    p.add_argument('--persona-b', type=str, default=None, help='Optional persona string for Agent B')
    p.add_argument('--persona-a-age', type=str, default=None, help='Optional age for Agent A')
    p.add_argument('--persona-a-background', type=str, default=None, help='Optional background for Agent A')
    p.add_argument('--persona-a-quirk', type=str, default=None, help='Optional speaking quirk for Agent A')
    p.add_argument('--persona-b-age', type=str, default=None, help='Optional age for Agent B')
    p.add_argument('--persona-b-background', type=str, default=None, help='Optional background for Agent B')
    p.add_argument('--persona-b-quirk', type=str, default=None, help='Optional speaking quirk for Agent B')
    p.add_argument('--model-a', type=str, default=None, help='Optional model name for Agent A (overrides env AGENT_A_MODEL)')
    p.add_argument('--model-b', type=str, default=None, help='Optional model name for Agent B (overrides env AGENT_B_MODEL)')
    p.add_argument('--max-chars', type=int, default=None, help='Optional max characters per reply')
    p.add_argument('--short-turn', action='store_true', help='Force replies to a single short sentence')
    return p.parse_args()
